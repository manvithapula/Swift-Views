...
//  TableViews
//
//  Created by admin64 on 03/10/24.
//
...
class EmojiTableViewController: UITableViewController {
    ...
    @IBAction func randomEmoji(_ coder: NSCoder,_ sender: Any) -> AddEditTableViewController? { if let cell = sender as? UITableViewCell, let indexPath = tableView.indexPath(for: cell) {
